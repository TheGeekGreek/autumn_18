...
\begin{definition}[Partial Derivative]
	Let $U \subseteq \mathbb{R}^n$ open, $F : U \to \mathbb{R}^m$ and $x_0 \in U$. If $F$ is differentiable at $x_0$, then define the \bld{$i$-th partial derivative of $F$ at $x_0$}, written $\partial_iF(x_0)$, by
	\begin{equation*}
