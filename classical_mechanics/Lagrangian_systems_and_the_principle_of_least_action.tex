...
\begin{definition}[Configuration Space]
	A \bld{configuration space}\index{Configuration space} is defined to be a finite-dimensional manifold in $\mathsf{Diff}$.
\end{definition}
...
\begin{definition}[State]
	A \bld{state of the configuration space}\index{State} is defined to be an element of the tangent bundle of the configuration space, called the \bld{state space}.
\end{definition}
...
\begin{definition}[Lagrangian System]
	A \bld{Lagrangian system}\index{Lagrangian!system} is defined to be a tuple $(M,L)$ consisting of an object $M \in \mathsf{Diff}$ and a function $L \in C^\infty(TM \times \mathbb{R})$, called a \bld{Lagrangian function}\index{Lagrangian!function}.
\end{definition}

\begin{example}
	\label{ex:Lagrangian}
	For $M \in \mathsf{Diff}$ let $T \in C^\infty(TM \times \mathbb{R})$ and $V \in C^\infty(M \times \mathbb{R})$. Define $L \in C^\infty(TM \times \mathbb{R})$ by $L := T - V$. In this situation, $T$ is called the \bld{kinetic energy} and $V$ is called the \bld{potential energy}.
\end{example}
...
\begin{example}[Motions on Riemannian Manifolds]
	Let $(M,g)$ be a Riemannian manifold of dimension $n$ and consider the Lagrangian $L$ on $M$ defined in example \ref{ex:Lagrangian} with
	\begin{equation*}
		T(q,v,t) := \frac{1}{2}g_q(v,v) = \frac{1}{2}\abs{v}^2_g
	\end{equation*}
	\noindent and $V(q,t) := 0$ for $q \in M$, $v \in T_qM$ and $t \in \mathbb{R}$. Let $(U,x^i)$ be a chart on $M$. We compute
	\begin{align*}
	...
	\begin{equation*}
		\frac{\partial L}{\partial \dot{x}^l}(q,v,t) = \frac{1}{2}g_{ij}(q)\delta^i_lv^j + \frac{1}{2}g_{ij}(q)v^i\delta^j_l = \frac{1}{2}g_{lj}(q)v^j + \frac{1}{2}g_{il}(q)v^i
	\end{equation*}
	\noindent implies
	\begin{align*}
		\frac{d}{dt}\frac{\partial L}{\partial \dot{x}^l}\del[1]{\gamma(t),\dot{\gamma}(t),t} &= \frac{1}{2}\frac{d}{dt}g_{lj}(\gamma)\dot{\gamma}^j + \frac{1}{2}g_{lj}(\gamma)\ddot{\gamma}^j + \frac{1}{2}\frac{d}{dt}g_{il}(\gamma)\dot{\gamma}^i + \frac{1}{2}g_{il}(\gamma)\ddot{\gamma}^i\\
	...
	\begin{equation*}
		0 = \frac{d}{dt}\frac{\partial L}{\partial \dot{x}^l} - \frac{\partial L}{\partial x^l} = g_{il}\ddot{\gamma}^i + \frac{1}{2}\del[3]{\frac{\partial g_{jl}}{\partial x^i} + \frac{\partial g_{il}}{\partial x^j} - \frac{\partial g_{ij}}{\partial x^l}}\dot{\gamma}^i\dot{\gamma}^j,	
	\end{equation*}
	...
	\end{equation*}
	\noindent are the \bld{Christoffel symbols} with respect to the choosen chart (see \cite[70]{lee:Riemannian_manifolds:1997}). Equation (\ref{eq:geodesic_equation}) is called the \bld{geodesic equation} (see \cite[58]{lee:Riemannian_manifolds:1997}). Hence extremals $\gamma$ of the action functional satisfy the geodesic equation and are therefore geodesics on the Riemannian manifold $M$.
\end{example}
