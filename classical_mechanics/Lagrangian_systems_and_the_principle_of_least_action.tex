...
\begin{example}
	\label{ex:Lagrangian}
	For $M \in \mathsf{Diff}$ let $T \in C^\infty(TM \times \mathbb{R})$ and $U \in C^\infty(M \times \mathbb{R})$. Define $L \in C^\infty(TM \times \mathbb{R})$ by $L := T - U$. In this situation, $T$ is called the \bld{kinetic energy} and $U$ is called the \bld{potential energy}.
\end{example}
