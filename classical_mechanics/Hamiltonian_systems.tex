...
\begin{definition}[Symmetry Group]
	A \bld{symmetry group of a Hamiltonian system $(M,\omega,H)$} is defined to be a Lie group $G$, such that there exists a Hamiltonian action of $G$ on $(M,\omega)$, such that
	\begin{equation*}
		H(g \cdot x) = H(x)
	\end{equation*}
