...
\begin{example}[Sheaf of Differential Forms]
	Let $M^n$ be a smooth manifold and let $0 \leq k \leq n$. Then by \ref{prop:section_sheaf}, $\mathcal{E}_{\upLambda^k(T^*M)}$ is a sheaf. This sheaf is denoted by $\upOmega^k_M$ and called the \bld{sheaf of differential $k$-forms}. As with tensor fields in example \ref{ex:tensor_sheaf},we can define a sheaf $\upOmega_M : \mathcal{O}(M) \to {_{\mathbb{R}}}\mathsf{GSCAlg}$ by
	\begin{equation*}
